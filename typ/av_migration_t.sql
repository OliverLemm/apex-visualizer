...
-- Attributes
  ...
  attribute_value          varchar2(4000), -- value of setting or attribute
  migration_effort_in_days number, -- effort to solve one finding in days
...
-- Constructors
  ...
  (
   ...
   ,i_item_label               in varchar2
   ,i_js_code_vc2              in varchar2
   ,i_plsql_code_vc2           in varchar2
   ,i_css_code_vc2             in varchar2
  ) return self as result,
...
create or replace type body av_migration_t is
  ...
  begin
    ...
    self.attribute_value          := i_attribute_value;
    self.migration_effort_in_days := i_migration_effort_in_days;
    self.migration_priority       := i_migration_priority;
  ...
  begin
    ...
    self.page_id                  := i_page_id;
    self.page_name                := i_page_name;
    self.component_name           := i_component_name;
    self.component_type           := i_component_type;
    self.region_name              := i_region_name;
    self.item_name                := i_item_name;
    self.item_label               := i_item_label;
    self.js_code_vc2              := i_js_code_vc2;
    self.plsql_code_vc2           := i_plsql_code_vc2;
    self.css_code_vc2             := i_css_code_vc2;
