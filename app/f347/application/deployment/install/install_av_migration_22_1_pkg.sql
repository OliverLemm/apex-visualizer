prompt --application/deployment/install/install_av_migration_22_1_pkg
begin
--   Manifest
--     INSTALL: INSTALL-av_migration_22_1_pkg
--   Manifest End
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(71862450479261275)
,p_install_id=>wwv_flow_imp.id(314927592265159640)
,p_name=>'av_migration_22_1_pkg'
,p_sequence=>230
...
'                                     ,i_rn_chapter_text          => ''As of this release, the following apex.env substitution strings are desupported: APP_IMAGES, IMAGE_PREFIX, THEME_DB_IMAGES, THEME_IMAGES, WORKSPACE_IMAGES. While the legacy substitu'
||'tions still function, Oracle recommends developers update their environments to use updated substitutions (listed below).''',
...
'                                     ,i_rn_chapter_text          => ''The Post Calculation functionality of page items is desupported. This functionality remains for existing page items where it has been used, but you can no longer set it for new page'
...
'                                     ,i_rn_chapter_text          => ''In Dynamic Actions, the Show and Hide actions have attributes Show all page items on same line and Hide all page items on same line, respectively. These attributes were designed for'
||' forms with a table-based layout. Because Universal Theme no longer uses table-based layout, these attributes are desupported.This functionality remains for existing Dynamic Actions where it was set to Yes, but developers cannot select it for new Dyn'
||'amic Actions.''',
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(71862513453261276)
,p_script_id=>wwv_flow_imp.id(71862450479261275)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'AV_MIGRATION_22_1_PKG'
);
