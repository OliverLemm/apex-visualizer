prompt --application/deployment/install/install_av_migration_20_2_pkg
begin
--   Manifest
--     INSTALL: INSTALL-av_migration_20_2_pkg
--   Manifest End
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(71861942651259481)
,p_install_id=>wwv_flow_imp.id(314927592265159640)
,p_name=>'av_migration_20_2_pkg'
,p_sequence=>220
...
'                                     ,i_rn_chapter_text          => ''The undocumented theme specific functions openModal and closeModal are desupported. Use the apex.theme.openRegion and apex.theme.closeRegion functions or the corresponding dynamic a'
||'ctions "Open Region" and "Close Region."''',
...
'                                     ,i_rn_chapter_text          => ''Creation of new legacy tabular forms is no longer supported as of this release. The APEX_ITEM API is considered legacy code and should not be used for new development. Existing tabu'
||'lar forms continue to function. Use interactive grids instead of tabular forms.''',
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(71862000089259481)
,p_script_id=>wwv_flow_imp.id(71861942651259481)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
,p_object_name=>'AV_MIGRATION_20_2_PKG'
);
