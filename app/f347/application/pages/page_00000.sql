...
,p_last_upd_yyyymmddhh24miss=>'20220805150843'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(452496424516540365)
,p_plug_name=>'Filter'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(449531905217422730)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(452496424516540365)
,p_button_name=>'SHOW_DETAILS'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:t-Button--iconRight'
,p_button_template_id=>wwv_flow_imp.id(452481802985466298)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(45068108221137631)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(32935929138378120)
...
,p_field_template=>wwv_flow_imp.id(452481109555466292)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(32937516050378136)
,p_name=>'P0_LINK'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(452496424516540365)
,p_prompt=>'Link'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(290526755762486790)
,p_name=>'P0_COMPONENT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(452496424516540365)
,p_prompt=>'Component'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(294476788366578348)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(449531235326422723)
,p_name=>'P0_PAGE_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(452496424516540365)
,p_prompt=>'Page'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(452496506236540366)
,p_name=>'P0_APP_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(452496424516540365)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(449532155105422733)
,p_name=>'Show Details'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(449531905217422730)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(449532263751422734)
,p_event_id=>wwv_flow_imp.id(449532155105422733)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(449532619134422737)
,p_event_id=>wwv_flow_imp.id(449532155105422733)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(32936982364378130)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(32937015388378131)
,p_event_id=>wwv_flow_imp.id(32936982364378130)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(32937155676378132)
,p_event_id=>wwv_flow_imp.id(32936982364378130)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(32937249040378133)
,p_event_id=>wwv_flow_imp.id(32936982364378130)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(32937796691378138)
,p_event_id=>wwv_flow_imp.id(32936982364378130)
,p_event_result=>'TRUE'
