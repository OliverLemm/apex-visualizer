...
,p_step_template=>wwv_flow_imp.id(452443100862466212)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38873272668053526)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(38870409361053521)
,p_button_name=>'LOGIN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38870874732053521)
,p_name=>'P510_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38870409361053521)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38871284755053523)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38872339463053525)
...
,p_lov=>'.'||wwv_flow_imp.id(38871578433053523)||'.'
,p_label_alignment=>'RIGHT'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(38874022768053528)
