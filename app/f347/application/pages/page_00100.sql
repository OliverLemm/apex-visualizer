...
,p_last_upd_yyyymmddhh24miss=>'20240101164054'
);
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(293281967558929170)
,p_region_id=>wwv_flow_imp.id(293281874355929169)
,p_chart_type=>'bar'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(293282008254929171)
,p_chart_id=>wwv_flow_imp.id(293281967558929170)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(293282248369929173)
,p_chart_id=>wwv_flow_imp.id(293281967558929170)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(293282193825929172)
,p_chart_id=>wwv_flow_imp.id(293281967558929170)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(293282571329929176)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(293282657022929177)
,p_region_id=>wwv_flow_imp.id(293282571329929176)
,p_chart_type=>'bar'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(293282728107929178)
,p_chart_id=>wwv_flow_imp.id(293282657022929177)
,p_seq=>10
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(293282980181929180)
,p_chart_id=>wwv_flow_imp.id(293282657022929177)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(293282893849929179)
,p_chart_id=>wwv_flow_imp.id(293282657022929177)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(293416813132888465)
,p_plug_name=>'Characters of JavaScript Code per Page'
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_imp.id(452458863643466246)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(141245744867649607)
,p_region_id=>wwv_flow_imp.id(293416813132888465)
,p_chart_type=>'bubble'
,p_height=>'400'
,p_animation_on_display=>'auto'
,p_animation_on_data_change=>'auto'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(141245870809649608)
,p_chart_id=>wwv_flow_imp.id(141245744867649607)
,p_seq=>10
,p_name=>'Series 1'
,p_location=>'REGION_SOURCE'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(141245904832649609)
,p_chart_id=>wwv_flow_imp.id(141245744867649607)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(141246004743649610)
,p_chart_id=>wwv_flow_imp.id(141245744867649607)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_title=>'code lines'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(293417040775888467)
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(293417138617888468)
,p_region_id=>wwv_flow_imp.id(293417040775888467)
,p_chart_type=>'donut'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(293417237204888469)
,p_chart_id=>wwv_flow_imp.id(293417138617888468)
,p_seq=>10
,p_name=>'New'
,p_location=>'REGION_SOURCE'
,p_series_name_column_name=>'APPLICATION_NAME'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(293417532690888472)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(293282369686929174)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(293282500350929175)
,p_event_id=>wwv_flow_imp.id(293282369686929174)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(293416813132888465)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(293283041326929181)
,p_event_id=>wwv_flow_imp.id(293282369686929174)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(293417040775888467)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(293416976852888466)
,p_event_id=>wwv_flow_imp.id(293282369686929174)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(293282571329929176)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(293417694705888473)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(293417705428888474)
,p_event_id=>wwv_flow_imp.id(293417694705888473)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(10188697440098612)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10188789871098613)
,p_event_id=>wwv_flow_imp.id(10188697440098612)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(293281874355929169)
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10188809607098614)
,p_event_id=>wwv_flow_imp.id(10188697440098612)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10188966711098615)
,p_event_id=>wwv_flow_imp.id(10188697440098612)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(10189035942098616)
,p_event_id=>wwv_flow_imp.id(10188697440098612)
,p_event_result=>'TRUE'
