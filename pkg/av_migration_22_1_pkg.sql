create or replace package av_migration_22_1_pkg is
  ...
  function ptf_des_8_1_1(i_app_id in number) return av_migrations_t
    pipelined;

  function ptf_des_8_1_2(i_app_id in number) return av_migrations_t
    pipelined;

  function ptf_des_8_1_4(i_app_id in number) return av_migrations_t
    pipelined;

  function ptf_des_8_1_6(i_app_id in number) return av_migrations_t
    pipelined;

  function ptf_des_8_1_7(i_app_id in number) return av_migrations_t
    pipelined;

  function ptf_des_8_1_13(i_app_id in number) return av_migrations_t
    pipelined;
